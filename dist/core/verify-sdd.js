 ...
 */
function parseVerificationChecklist(content) {
 ...
 */
function detectScopeSize(content) {
 ...
 */
function checkFileExists(check, projectRoot) {
 ...
 */
function evaluateCheck(check, completed, projectRoot) {
    if (completed) {
 ...
 */
export function runSddVerification(changeDir, projectRoot) {
...
//# sourceMappingURL=verify-sdd.js.map