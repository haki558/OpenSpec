...
export class InitCommand {
  ...
  private async selectSchema(): Promise<string> {
  ...
  private getConfigContent(schemaName: string): string {
  ...
  private async scaffoldActiveWork(openspecPath: string): Promise<void> {
